...
export const TourPriceCategoryUpdateArgsSchema: z.ZodType<Prisma.TourPriceCategoryUpdateArgs> = z.object({
  select: TourPriceCategorySelectSchema.optional(),
  include: z.lazy(() => TourPriceCategoryIncludeSchema).optional(),
  data: z.union([ TourPriceCategoryUpdateInputSchema,TourPriceCategoryUncheckedUpdateInputSchema ]),
  where: TourPriceCategoryWhereUniqueInputSchema,
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default TourPriceCategoryUpdateArgsSchema;

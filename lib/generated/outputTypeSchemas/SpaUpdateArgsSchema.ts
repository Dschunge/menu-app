...
export const SpaUpdateArgsSchema: z.ZodType<Prisma.SpaUpdateArgs> = z.object({
  select: SpaSelectSchema.optional(),
  include: z.lazy(() => SpaIncludeSchema).optional(),
  data: z.union([ SpaUpdateInputSchema,SpaUncheckedUpdateInputSchema ]),
  where: SpaWhereUniqueInputSchema,
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default SpaUpdateArgsSchema;

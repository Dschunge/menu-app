...
export const DishCreateArgsSchema: z.ZodType<Prisma.DishCreateArgs> = z.object({
  select: DishSelectSchema.optional(),
  include: z.lazy(() => DishIncludeSchema).optional(),
  data: z.union([ DishCreateInputSchema,DishUncheckedCreateInputSchema ]),
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default DishCreateArgsSchema;

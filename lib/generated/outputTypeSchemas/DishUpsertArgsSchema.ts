...
import { DishCreateInputSchema } from '../inputTypeSchemas/DishCreateInputSchema'
import { DishUncheckedCreateInputSchema } from '../inputTypeSchemas/DishUncheckedCreateInputSchema'
import { DishUpdateInputSchema } from '../inputTypeSchemas/DishUpdateInputSchema'
import { DishUncheckedUpdateInputSchema } from '../inputTypeSchemas/DishUncheckedUpdateInputSchema'
...
export const DishUpsertArgsSchema: z.ZodType<Prisma.DishUpsertArgs> = z.object({
  select: DishSelectSchema.optional(),
  include: z.lazy(() => DishIncludeSchema).optional(),
  where: DishWhereUniqueInputSchema,
  create: z.union([ DishCreateInputSchema,DishUncheckedCreateInputSchema ]),
  update: z.union([ DishUpdateInputSchema,DishUncheckedUpdateInputSchema ]),
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default DishUpsertArgsSchema;

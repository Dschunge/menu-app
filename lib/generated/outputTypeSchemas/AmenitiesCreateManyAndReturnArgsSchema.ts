...
export const AmenitiesCreateManyAndReturnArgsSchema: z.ZodType<Prisma.AmenitiesCreateManyAndReturnArgs> = z.object({
  data: z.union([ AmenitiesCreateManyInputSchema,AmenitiesCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default AmenitiesCreateManyAndReturnArgsSchema;

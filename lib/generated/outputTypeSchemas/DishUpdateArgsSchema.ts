...
export const DishUpdateArgsSchema: z.ZodType<Prisma.DishUpdateArgs> = z.object({
  select: DishSelectSchema.optional(),
  include: z.lazy(() => DishIncludeSchema).optional(),
  data: z.union([ DishUpdateInputSchema,DishUncheckedUpdateInputSchema ]),
  where: DishWhereUniqueInputSchema,
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default DishUpdateArgsSchema;

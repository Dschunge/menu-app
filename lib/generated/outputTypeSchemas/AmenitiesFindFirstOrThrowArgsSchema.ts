...
export const AmenitiesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.AmenitiesFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ AmenitiesScalarFieldEnumSchema,AmenitiesScalarFieldEnumSchema.array() ]).optional(),
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default AmenitiesFindFirstOrThrowArgsSchema;

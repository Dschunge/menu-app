...
export const AmenitiesUpdateArgsSchema: z.ZodType<Prisma.AmenitiesUpdateArgs> = z.object({
  select: AmenitiesSelectSchema.optional(),
  include: z.lazy(() => AmenitiesIncludeSchema).optional(),
  data: z.union([ AmenitiesUpdateInputSchema,AmenitiesUncheckedUpdateInputSchema ]),
  where: AmenitiesWhereUniqueInputSchema,
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default AmenitiesUpdateArgsSchema;

...
export const SpaPriceCategoryCreateManyArgsSchema: z.ZodType<Prisma.SpaPriceCategoryCreateManyArgs> = z.object({
  data: z.union([ SpaPriceCategoryCreateManyInputSchema,SpaPriceCategoryCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default SpaPriceCategoryCreateManyArgsSchema;

...
export const SpaCreateArgsSchema: z.ZodType<Prisma.SpaCreateArgs> = z.object({
  select: SpaSelectSchema.optional(),
  include: z.lazy(() => SpaIncludeSchema).optional(),
  data: z.union([ SpaCreateInputSchema,SpaUncheckedCreateInputSchema ]),
  relationLoadStrategy: RelationLoadStrategySchema.optional(),
}).strict() ;

export default SpaCreateArgsSchema;

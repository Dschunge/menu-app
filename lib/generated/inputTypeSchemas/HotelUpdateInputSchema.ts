...
import { ActivityUpdateManyWithoutHotelNestedInputSchema } from './ActivityUpdateManyWithoutHotelNestedInputSchema';
import { TourUpdateManyWithoutHotelNestedInputSchema } from './TourUpdateManyWithoutHotelNestedInputSchema';
import { SpaUpdateManyWithoutHotelNestedInputSchema } from './SpaUpdateManyWithoutHotelNestedInputSchema';
import { AmenitiesUpdateManyWithoutHotelNestedInputSchema } from './AmenitiesUpdateManyWithoutHotelNestedInputSchema';
import { TVChannelsUpdateManyWithoutHotelNestedInputSchema } from './TVChannelsUpdateManyWithoutHotelNestedInputSchema';
...
export const HotelUpdateInputSchema: z.ZodType<Prisma.HotelUpdateInput> = z.object({
  ...
  activities: z.lazy(() => ActivityUpdateManyWithoutHotelNestedInputSchema).optional(),
  tours: z.lazy(() => TourUpdateManyWithoutHotelNestedInputSchema).optional(),
  spa: z.lazy(() => SpaUpdateManyWithoutHotelNestedInputSchema).optional(),
  amenities: z.lazy(() => AmenitiesUpdateManyWithoutHotelNestedInputSchema).optional(),
  tvchannels: z.lazy(() => TVChannelsUpdateManyWithoutHotelNestedInputSchema).optional()
}).strict();

export default HotelUpdateInputSchema;

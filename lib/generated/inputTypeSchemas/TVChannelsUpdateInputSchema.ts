...
import { HotelUpdateOneWithoutTvchannelsNestedInputSchema } from './HotelUpdateOneWithoutTvchannelsNestedInputSchema';

export const TVChannelsUpdateInputSchema: z.ZodType<Prisma.TVChannelsUpdateInput> = z.object({
  ...
  Hotel: z.lazy(() => HotelUpdateOneWithoutTvchannelsNestedInputSchema).optional()
}).strict();

export default TVChannelsUpdateInputSchema;

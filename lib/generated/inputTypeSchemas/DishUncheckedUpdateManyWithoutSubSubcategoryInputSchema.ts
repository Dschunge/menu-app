...
export const DishUncheckedUpdateManyWithoutSubSubcategoryInputSchema: z.ZodType<Prisma.DishUncheckedUpdateManyWithoutSubSubcategoryInput> = z.object({
  ...
  menuId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  course_number: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export default DishUncheckedUpdateManyWithoutSubSubcategoryInputSchema;

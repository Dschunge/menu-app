...
import { TourPriceCategoryUpdateManyWithoutTourNestedInputSchema } from './TourPriceCategoryUpdateManyWithoutTourNestedInputSchema';
import { HotelUpdateOneRequiredWithoutToursNestedInputSchema } from './HotelUpdateOneRequiredWithoutToursNestedInputSchema';
...
export const TourUpdateInputSchema: z.ZodType<Prisma.TourUpdateInput> = z.object({
  ...
  pricecategory: z.lazy(() => TourPriceCategoryUpdateManyWithoutTourNestedInputSchema).optional(),
  Hotel: z.lazy(() => HotelUpdateOneRequiredWithoutToursNestedInputSchema).optional()
}).strict();

export default TourUpdateInputSchema;

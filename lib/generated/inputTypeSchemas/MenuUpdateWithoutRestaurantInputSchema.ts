...
import { DishUpdateManyWithoutMenuNestedInputSchema } from './DishUpdateManyWithoutMenuNestedInputSchema';
...
export const MenuUpdateWithoutRestaurantInputSchema: z.ZodType<Prisma.MenuUpdateWithoutRestaurantInput> = z.object({
  ...
  dishes: z.lazy(() => DishUpdateManyWithoutMenuNestedInputSchema).optional()
}).strict();

export default MenuUpdateWithoutRestaurantInputSchema;

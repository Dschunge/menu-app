...
import { DishUncheckedUpdateManyWithoutMenuNestedInputSchema } from './DishUncheckedUpdateManyWithoutMenuNestedInputSchema';
...
export const MenuUncheckedUpdateInputSchema: z.ZodType<Prisma.MenuUncheckedUpdateInput> = z.object({
  ...
  dishes: z.lazy(() => DishUncheckedUpdateManyWithoutMenuNestedInputSchema).optional()
}).strict();

export default MenuUncheckedUpdateInputSchema;

...
import { SpaPriceCategoryUncheckedUpdateManyWithoutSpaNestedInputSchema } from './SpaPriceCategoryUncheckedUpdateManyWithoutSpaNestedInputSchema';

export const SpaUncheckedUpdateWithoutHotelInputSchema: z.ZodType<Prisma.SpaUncheckedUpdateWithoutHotelInput> = z.object({
  ...
  pricecategory: z.lazy(() => SpaPriceCategoryUncheckedUpdateManyWithoutSpaNestedInputSchema).optional()
}).strict();

export default SpaUncheckedUpdateWithoutHotelInputSchema;

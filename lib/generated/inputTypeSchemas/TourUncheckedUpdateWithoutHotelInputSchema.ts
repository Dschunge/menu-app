...
import { TourPriceCategoryUncheckedUpdateManyWithoutTourNestedInputSchema } from './TourPriceCategoryUncheckedUpdateManyWithoutTourNestedInputSchema';

export const TourUncheckedUpdateWithoutHotelInputSchema: z.ZodType<Prisma.TourUncheckedUpdateWithoutHotelInput> = z.object({
  ...
  pricecategory: z.lazy(() => TourPriceCategoryUncheckedUpdateManyWithoutTourNestedInputSchema).optional()
}).strict();

export default TourUncheckedUpdateWithoutHotelInputSchema;

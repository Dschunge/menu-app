...
export const RestaurantUpdateOneRequiredWithoutCategoriesNestedInputSchema: z.ZodType<Prisma.RestaurantUpdateOneRequiredWithoutCategoriesNestedInput> = z.object({
  ...
  upsert: z.lazy(() => RestaurantUpsertWithoutCategoriesInputSchema).optional(),
  connect: z.lazy(() => RestaurantWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => RestaurantUpdateToOneWithWhereWithoutCategoriesInputSchema),z.lazy(() => RestaurantUpdateWithoutCategoriesInputSchema),z.lazy(() => RestaurantUncheckedUpdateWithoutCategoriesInputSchema) ]).optional(),
}).strict();

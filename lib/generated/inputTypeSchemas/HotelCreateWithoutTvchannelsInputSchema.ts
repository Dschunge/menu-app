...
import { ActivityCreateNestedManyWithoutHotelInputSchema } from './ActivityCreateNestedManyWithoutHotelInputSchema';
...
export const HotelCreateWithoutTvchannelsInputSchema: z.ZodType<Prisma.HotelCreateWithoutTvchannelsInput> = z.object({
  ...
  activities: z.lazy(() => ActivityCreateNestedManyWithoutHotelInputSchema).optional(),
...
export default HotelCreateWithoutTvchannelsInputSchema;

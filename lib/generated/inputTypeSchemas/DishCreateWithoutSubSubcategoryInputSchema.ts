...
import { MenuCreateNestedOneWithoutDishesInputSchema } from './MenuCreateNestedOneWithoutDishesInputSchema';

export const DishCreateWithoutSubSubcategoryInputSchema: z.ZodType<Prisma.DishCreateWithoutSubSubcategoryInput> = z.object({
  ...
  menu: z.lazy(() => MenuCreateNestedOneWithoutDishesInputSchema).optional()
}).strict();

export default DishCreateWithoutSubSubcategoryInputSchema;

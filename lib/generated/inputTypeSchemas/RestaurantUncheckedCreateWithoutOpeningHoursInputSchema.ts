...
import { ReservationUncheckedCreateNestedManyWithoutRestaurantInputSchema } from './ReservationUncheckedCreateNestedManyWithoutRestaurantInputSchema';

export const RestaurantUncheckedCreateWithoutOpeningHoursInputSchema: z.ZodType<Prisma.RestaurantUncheckedCreateWithoutOpeningHoursInput> = z.object({
  ...
  reservations: z.lazy(() => ReservationUncheckedCreateNestedManyWithoutRestaurantInputSchema).optional()
}).strict();

export default RestaurantUncheckedCreateWithoutOpeningHoursInputSchema;

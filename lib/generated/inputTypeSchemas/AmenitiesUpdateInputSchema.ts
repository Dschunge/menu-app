...
import { HotelUpdateOneWithoutAmenitiesNestedInputSchema } from './HotelUpdateOneWithoutAmenitiesNestedInputSchema';

export const AmenitiesUpdateInputSchema: z.ZodType<Prisma.AmenitiesUpdateInput> = z.object({
  ...
  Hotel: z.lazy(() => HotelUpdateOneWithoutAmenitiesNestedInputSchema).optional()
}).strict();

export default AmenitiesUpdateInputSchema;

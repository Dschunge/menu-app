...
import { HotelUpdateOneWithoutActivitiesNestedInputSchema } from './HotelUpdateOneWithoutActivitiesNestedInputSchema';
...
export const ActivityUpdateInputSchema: z.ZodType<Prisma.ActivityUpdateInput> = z.object({
  ...
  Hotel: z.lazy(() => HotelUpdateOneWithoutActivitiesNestedInputSchema).optional()
}).strict();

export default ActivityUpdateInputSchema;

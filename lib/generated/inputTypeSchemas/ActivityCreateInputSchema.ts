...
import { HotelCreateNestedOneWithoutActivitiesInputSchema } from './HotelCreateNestedOneWithoutActivitiesInputSchema';
...
export const ActivityCreateInputSchema: z.ZodType<Prisma.ActivityCreateInput> = z.object({
  ...
  Hotel: z.lazy(() => HotelCreateNestedOneWithoutActivitiesInputSchema).optional()
}).strict();

export default ActivityCreateInputSchema;

...
import { TourPriceCategoryCreateNestedManyWithoutTourInputSchema } from './TourPriceCategoryCreateNestedManyWithoutTourInputSchema';
import { HotelCreateNestedOneWithoutToursInputSchema } from './HotelCreateNestedOneWithoutToursInputSchema';
...
export const TourCreateInputSchema: z.ZodType<Prisma.TourCreateInput> = z.object({
  ...
  pricecategory: z.lazy(() => TourPriceCategoryCreateNestedManyWithoutTourInputSchema).optional(),
  Hotel: z.lazy(() => HotelCreateNestedOneWithoutToursInputSchema).optional()
}).strict();

export default TourCreateInputSchema;
